...
normall<-function(name)
{
  ...
  renew_res<-c(name,renew_res,"Source","renewable ressources","renewable ressources")
  ...
  non_renew_res<-c(name,non_renew_res,"Source","non-renewable ressources","non-renewable ressources")
  ...
  Source<-c(name,Source,"Source","Source","Source")
  ...
  global_sys<-c(name,global_sys,"Sink","global System","global System")
  ...
  crit_ecosys<-c(name,crit_ecosys,"Sink","critical ecosystems","critical ecosystems")
  ...
  Sink<-c(name,Sink_sys,"Sink","Sink","Sink")
  ...
  life<-ecosys
  ecosys<-c(name,ecosys,"Life support","ecosystem health","ecosystem health")

  table<-rbind(table,ecosys)
  
  life<-c(name,life,"Life support","Life support","Life support")
  ...
  human_he<-c(name,human_he,"Human health and welfare","human health","human health")
  ...
  land_ame<-c(name,land_ame,"Human health and welfare","landscape and amenity","landscape and amenitys")
  ...
  Welfare<-c(name,Welfare_sys,"Human health and welfare","Human health and welfare","Human health and welfare")
  ...
  SESI_layer<-c(name,SESI_layer,n-1,"SESI layer","SESI layer")
...
```{r warning=FALSE,message=FALSE,results='hide'}
dataEU<-read.csv("europe.csv",sep = ";")
Countries<-unique(dataEU$Country)
